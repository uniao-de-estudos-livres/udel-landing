    ...
    <footer className="bg-black border-t border-zinc-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1: Logo, Description, Social - Always centered */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { name: "Recursos", href: "#" },
                { name: "Questões", href: "/questions" }, // Link para dashboard/questions
                { name: "Estatísticas", href: "/statistics" }, // Link para dashboard/statistics
                { name: "Clubes", href: "#" },
                { name: "Eventos", href: "#" },
              ].map((link, index) => (
                <li key={index}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { name: "FAQ", href: "/faq" }, // Updated link
                { name: "Contato", href: "/contact" }, // Updated link
                { name: "Reportar Bug", href: "#" },
                { name: "Sugerir Recurso", href: "#" },
                { name: "Política de Privacidade", href: "/privacy" }, // Updated link
              ].map((link, index) => (
                <li key={index}>
                  <Link href={link.href} className="text-zinc-400 hover:text-purple-400 transition-colors text-sm">
                    {link.name}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { name: "Discord", href: "#" }, // Keep placeholder or add real link
                { name: "Blog", href: "#" },
        ...
        <div className="border-t border-zinc-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/privacy" className="text-zinc-500 hover:text-purple-400 text-sm transition-colors"> {/* Updated link */}
